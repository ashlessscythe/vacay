...
export default function DashboardPage() {
  ...
  const pendingRequests = Array.isArray(leaves)
    ? leaves.filter((leave) => leave.status === 1).length
    : 0;
  ...
  return (
    <div className="space-y-6 relative">
      ...
      <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-400 bg-clip-text text-transparent animate-gradient">
        Dashboard
      </h2>
